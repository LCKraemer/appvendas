...
class BannerVenda(GridLayout):
    def __init__(self, **kwargs):  # init reescreve info da super(GridLayout). Classe perde caracteristicas da super.
        ...
        cliente = kwargs["cliente"]  # **kwargs automaticamente cria parametros passados.
        ...
        direita_label_preco = Label(text=f"R$ {preco:,.2f}", size_hint=(1, 0.33), pos_hint={"right": 1, "top": 0.65})
